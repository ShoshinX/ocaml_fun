...
let solutions = 
    [(string_of_int (q1_solve (explode q1_input) 0))
    ;(string_of_int (q1b_solve (explode "()())") 0 0))
    ;(string_of_int (d2_solve d2_input))
    ;(string_of_int (d2b_solve d2_input))
    ;(string_of_int (d3a_solve d3_input 0 0))
    ;(string_of_int (d3b_solve d3_input 0 0))
